...
import com.kamppi.testgame.Game;
...
public class Textures {
	...
	public static void load() {
		try {
			...
			FADE = ImageIO.read(Game.class.getResource("/textures/tile/fade.png")).getScaledInstance(32, 32, Image.SCALE_FAST);
			
			toList(BREAK_0 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_0.png")), BREAK_STAGES);
			toList(BREAK_1 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_1.png")), BREAK_STAGES);
			toList(BREAK_2 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_2.png")), BREAK_STAGES);
			toList(BREAK_3 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_3.png")), BREAK_STAGES);
			toList(BREAK_4 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_4.png")), BREAK_STAGES);
			toList(BREAK_5 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_5.png")), BREAK_STAGES);
			toList(BREAK_6 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_6.png")), BREAK_STAGES);
			toList(BREAK_7 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_7.png")), BREAK_STAGES);
			toList(BREAK_8 = ImageIO.read(Game.class.getResource("/textures/tile/destroy_stage_8.png")), BREAK_STAGES);
